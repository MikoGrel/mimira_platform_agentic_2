  ...
  return (
    ...
    >
      <CardBody className="p-4 space-y-3">
        ...
        {product.closest_match && (
          <div className="text-[13px] text-gray-700 space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-700">Najbliższe dopasowanie</span>
            </div>
            <div className="pt-2">
        ...
        {splitToList(product.requirements_to_confirm).length > 0 && (
          <div className="text-[13px] text-gray-700 space-y-1">
            <div className="flex items-center gap-2 text-gray-700">
              ...
              <span className="text-gray-700">Wymagania do potwierdzenia</span>
            </div>
            <ul className="space-y-1 pl-2 pt-2">
              {splitToList(product.requirements_to_confirm).map((line, i) => (
        ...
        {splitToList(product.alternative_products).length > 0 && (
          <div className="text-[13px] text-gray-700 space-y-1">
            <div className="flex items-center gap-2 text-gray-700">
              ...
              <span className="text-gray-700">Produkty alternatywne</span>
            </div>
            <ul className="space-y-1 pl-2 pt-2">
              {splitToList(product.alternative_products).map((line, i) => (
                <li key={i} className="flex items-start gap-2 text-gray-700">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-300" />
                  <span>{line}</span>
                </li>
